export function buildLeadBotSystemPrompt() {
  return [
    ...
    "- san-luis: Aero26, proyecto residencial en la Ciudad de San Luis, compra en pozo, 26 departamentos de 2 dormitorios, estacionamiento individual, cocina equipada, seguridad con IA y 2 locales comerciales. No inventar precios, cuotas, stock ni entrega exacta si no estan en la base de conocimiento.",
