...
const PROJECTS = [
    ...
    },
    {
        ...
        description: "Torre privada Coradir en San Luis, con unidades residenciales consolidadas y propuesta de alta calidad.",
        href: "https://torreprivada.coradir.com.ar/",
        image: "/img/projects/torre1.webp",
        ctaId: "proyectos-la-torre-i-coradir",
    },
    {
        name: "La Torre II",
...
const ctaClassName =
    "mt-auto inline-flex items-center justify-center rounded-full bg-blue px-6 py-3 font-raleway text-sm uppercase tracking-wide text-white transition hover:bg-blue/80";
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-4 p-6">
                                    ...
                                    {isExternal ? (
                                        ...
                                        <Link href={project.href} id={project.ctaId} className={ctaClassName}>
                                            Ver detalles
                                        </Link>
                                    )}
                                </div>
