...
export const TERRENOS_COPY = {
  ...
  highlights: [
    ...
    },
    {
      ...
      description: "Los alquileres generan ingresos recurrentes y aumentan tu patrimonio sin esfuerzo.",
    },
  ],
};

export const INVERSIONES_COPY = {
  heroTitle: "Inversiones",
...
export const CASA_JOVEN_COPY = {
  ...
  highlights: [
    {
      title: "Confort total desde el primer dia",
      description: "Olvidate del mantenimiento y de la infraestructura inicial.",
    },
    {
  ...
  closing: "Vivir bien nunca fue tan sencillo. Conecta con nosotros y encontra el hogar que se adapta a vos.",
};

export const TESTIMONIALS_COPY = {
  organizationName: "Coradir Homes",
  aggregateRating: {
    ratingValue: "4.8",
    reviewCount: "124",
    bestRating: "5",
...
export type SaberMasLandingCopy = {
  heroTitle: string;
  heroSubtitle: string;
  description: string;
  clusters: SaberMasCluster[];
  faqs?: FaqItem[];
};
    ...
    clusters: [
      {
        ...
        cta: {
          label: "Ver soluciones corporativas",
          href: "/corporativos",
        },
      },
      {
    ...
    clusters: [
      {
        ...
        cta: {
          label: "Conocer modelo para terrenos",
          href: "/terrenos",
        },
      },
      {
    ...
    clusters: [
      {
        ...
        cta: {
          label: "Ver detalles de Casa Joven",
          href: "/casa-joven/ejemploPage",
        },
      },
      {
