...
ARG NEXT_PUBLIC_LEAD_BOT_ENABLED
ARG NEXT_PUBLIC_LEAD_BOT_WHATSAPP_NUMBER
...
ENV NEXT_PUBLIC_LEAD_BOT_ENABLED=${NEXT_PUBLIC_LEAD_BOT_ENABLED}
ENV NEXT_PUBLIC_LEAD_BOT_WHATSAPP_NUMBER=${NEXT_PUBLIC_LEAD_BOT_WHATSAPP_NUMBER}
